                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                        {services.map((s) => {
                            ...
                            return (
                                <div
                                    key={s.title}
                                    className={`rounded-2xl border flex flex-col overflow-hidden hover:-translate-y-1 transition-transform duration-300 ${isPurple
                                        ? "border-(--my-purple)/20"
                                        : "border-(--my-green)/20"
                                        }`}
                                >
                                    ...
                                    <div className="relative h-60 w-full shrink-0">
                                        ...
                                        {/* Icon badge pinned bottom-left over image */}
                                        <div className={`absolute bottom-4 left-5 w-11 h-11 rounded-xl flex items-center justify-center text-white shadow-lg ${isPurple ? "bg-(--my-purple)" : "bg-(--my-green)"
                                            }`}>
                                            {s.icon}
                                        </div>
                                    </div>
                                    ...
                                    {/* ── Content ── */}
                                    <div className={`p-7 flex flex-col flex-1 ${isPurple ? "bg-(--my-purple)/10" : "bg-(--my-green)/10"
                                        }`}>
