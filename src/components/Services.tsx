...
const services = [
    {
        ...
        description: "Expert guidance on HSE policy, safety systems, audits, hazard assessments, and incident management to ensure compliance and operational safety."
    },
    {
