...
const Footer = () => {
    return (
        <div className="relative overflow-hidden bg-linear-to-br from-black via-[#0b0f1f] to-[#0f172a] text-white  pb-6 py-16">
                        ...
                        <div className="flex flex-col text-gray-400">
                            ...
                            <div className="flex gap-3 items-center hover:bg-[#19151520] rounded-lg p-2 transition-colors">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <h4 className="text-sm font-bold tracking-wider">Phone</h4>
                            ...
                            <div className="flex gap-3 items-center hover:bg-[#19151520] rounded-lg p-2 transition-colors">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <h4 className="text-sm font-bold tracking-wider">Email</h4>
                                    <p className="text-xs truncate"><a href="mailto:info@tabhseservices.com" target="_blank">info@tabhseservices.com</a></p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3 items-center hover:bg-[#19151520] rounded-lg p-2 transition-colors">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <h4 className="text-sm font-bold tracking-wider">Office</h4>
                            ...
                            <div className="flex gap-3 items-center hover:bg-[#19151520] rounded-lg p-2 transition-colors">
                                ...
                                <div className="flex flex-col min-w-0">
                                    <h4 className="text-sm font-bold tracking-wider">LinkedIn</h4>
