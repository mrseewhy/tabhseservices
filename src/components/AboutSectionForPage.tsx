...
//                             <h2 className=" text-3xl font-bold  text-gray-900 sm:text-4xl md:text-5xl"> About  <span className="text-(--my-green)">TAB HSE Services</span></h2>
//                         </div>
...
//                             </p>
//                             <p>
//                                 Our expertise empowers
//                                 organizations to not only meet regulatory demands but to excel,
//                                 transforming their operations into models of efficiency,
//                                 responsibility, and long-term viability. From comprehensive
                    ...
                    <div className="mt-16 md:mt-0 md:w-1/2">
                        ...
                        <div className="mt-8 grid grid-cols-3 gap-4">
                            <div className="rounded-2xl bg-(--my-purple)/10 border border-(--my-purple)/20 p-4 text-center">
                                <p className="text-2xl font-black text-(--my-purple)">100+</p>
